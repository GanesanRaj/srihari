                            ...
                            <div class="card mb-0">
                                <div class="card-body py-1 d-flex align-items-center gap-3 flex-wrap">
                                    ...
                                    <div class="ms-2 d-flex gap-1">
                                        <a href="manifest-list.php" class="btn btn-sm btn-outline-secondary">
                        ...
                        <div class="col-lg-3">
                            <div class="card mb-0">
                                ...
                                <div class="card-body py-2 px-2">
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label fs-12 mb-0">Coloader / Vehicle</label>
                                        <input type="text" id="coloader" class="form-control form-control-sm"
                                            placeholder="Transport / coloader name">
                                    </div>
                                    <div class="mb-1">
            ...
            <script>
                $(function () {
                    ...
                    function updateStatusBadge(status) {
                        ...
                        const colors = { draft: 'warning text-dark', dispatched: 'primary', received: 'success' };
                        $('#manifestStatusBadge')
