<?php
/**
 * Consignee Create API
 * Location: /apps-api/consignee/create.php
 */
...
try {
    ...
    if ($stmt->execute()) {
        echo json_encode(['status' => 'success', 'message' => 'Consignee created successfully', 'id' => $pdo->lastInsertId()]);
    } else {
        echo json_encode(['status' => 'error', 'message' => 'Failed to create consignee']);
    }
