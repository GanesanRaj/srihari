<?php
/**
 * Consignor Edit/Update API
 * Location: /apps-api/consignor/edit.php
 */
...
try {
    ...
    if ($stmt->execute()) {
        echo json_encode(['status' => 'success', 'message' => 'Consignor updated successfully']);
    } else {
        echo json_encode(['status' => 'error', 'message' => 'Failed to update consignor']);
    }
