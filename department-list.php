...
// require_permission('department', 'is_view');

// Get permissions
$can_add = true; // can_add('department');
$can_edit = true; // can_edit('department');
$can_delete = true; // can_delete('department');
?>
            ...
            <div class="content">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Department List</h4>
                    </div>
                    <div class="text-end">
                        <?php if ($can_add): ?>
                            <a href="department-add.php" class="btn btn-sm btn-soft-primary">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="departmentTable" class="table table-hover dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
            ...
            <script>
                ...
                $(document).ready(function () {
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    if (userPermissions.canEdit) {
                                        actions += `<a href="department-add.php?id=${row.id}" class="btn btn-sm btn-soft-primary" title="Edit"><i class="ti ti-edit"></i></a>`;
                                    }
                    ...
                    $('#departmentTable').on('click', '.delete-btn', function () {
                        let id = $(this).data('id');
                        if (confirmDelete('Are you sure you want to delete this department?')) {
                            $.post('api/department/delete.php', { id: id }, function (response) {
