        ...
        <div class="content-page">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="py-1 d-flex align-items-sm-center flex-sm-row flex-column">
                                        <div class="flex-grow-1">
                                            <h6 class="fs-14 fw-semibold m-0"> <i data-lucide="zap"></i> Delhivery B2C Shipment List</h4>
                                        </div>
                                        <div class="text-end">
                                            <a href="delhivery-b2c-shipment-create.php" class="btn btn-primary btn-sm">
                                                <i class="ti ti-plus me-1"></i> New B2C Shipment
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <style>
                                        ...
                                        .nav-tabs-custom .nav-link.active {
                                            color: #da7d41;
                                            border-bottom: 2px solid #da7d41;
                                            background: transparent;
                                        }
                                    </style>

                                    <ul class="nav nav-tabs nav-tabs-custom mb-3 flex-wrap" id="b2cStatusTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#" role="tab" data-tab="all">
                                                All <span class="badge bg-primary ms-1" id="badge-all">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="soft_date_uploaded">
                                                Soft Date Uploaded <span class="badge bg-secondary ms-1" id="badge-soft_date_uploaded">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="synced_ready_to_ship">
                                                Synced / Ready to Ship <span class="badge bg-info ms-1" id="badge-synced_ready_to_ship">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="ready_for_pickup">
                                                Ready for Pickup <span class="badge bg-warning text-dark ms-1" id="badge-ready_for_pickup">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="in_transit">
                                                In Transit <span class="badge bg-primary ms-1" id="badge-in_transit">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="return_to_origin">
                                                RTO <span class="badge bg-danger ms-1" id="badge-return_to_origin">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="delivered">
                                                Delivered <span class="badge bg-success ms-1" id="badge-delivered">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="ndr_shipment">
                                                NDR <span class="badge bg-danger ms-1" id="badge-ndr_shipment">0</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" data-tab="cancelled">
                                                Cancelled <span class="badge bg-secondary ms-1" id="badge-cancelled">0</span>
                                            </a>
                                        </li>
                                    </ul>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    // Load Couriers for Filter — auto-select Delhivery for B2C list
                    ...
                    function loadTabCounts() {
                        const params = {
                            ...
                            courier_id: $('#courierFilter').val(),
                            from_date: startDate,
                            to_date: endDate
                        };
                        $.get('api/shipment/b2c_status_counts.php', params, function(res) {
                            if (res && res.status === 'success' && res.counts) {
                                for(let key in res.counts) {
                                    $(`#badge-${key}`).text(res.counts[key]);
                                }
                            }
                        });
                    }
                    ...
                    // Tab clicks
                    $('#b2cStatusTabs .nav-link').click(function(e) {
                        e.preventDefault();
                        $('#b2cStatusTabs .nav-link').removeClass('active');
