...
// require_permission('master_status', 'is_view');

// Get permissions
$can_add = true; // can_add('master_status');
$can_edit = true; // can_edit('master_status');
$can_delete = true; // can_delete('master_status');
?>
                ...
                <div class="">
                    ...
                    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-18 fw-semibold m-0">Status Description List</h4>
                        </div>
                        <div class="text-end">
                            <?php if ($can_add): ?>
                                <a href="master-status-add.php" class="btn btn-sm btn-soft-primary">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="statusTable" class="table table-hover dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Status Name</th>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    var table = $('#statusTable').DataTable({
                        ...
                        ajax: {
                            url: 'api/master_status/read.php',
                            type: 'GET',
                            data: function (d) {
                        ...
                        columns: [
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    <?php if ($can_edit): ?>
                                        actionButtons += `<a href="master-status-add.php?id=${row.id}" class="btn btn-sm btn-soft-primary"><i class="ti ti-edit"></i> Edit</a>`;
                                    <?php endif; ?>
                                    <?php if ($can_delete): ?>
                    ...
                    $(document).on('click', '.delete-btn', function () {
                        let id = $(this).data('id');
                        confirmDelete('Are you sure you want to delete this status?', function () {
                            $.ajax({
                                url: `api/master_status/delete.php?id=${id}`,
                                type: 'GET',
                                ...
                                error: function () {
                                    showtoastt('Error deleting status', 'error');
                                }
                            });
                        });
                    });
